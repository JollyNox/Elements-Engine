 ...
 * Updated on 23 January 2012 for SFML 2.0
 */
...
sf::Rect<int> Collision::GetAABB(const sf::Sprite& Object) {
    ...
    if (Angle == 0.0f) {
        return sf::Rect<int>(static_cast<int> (pos.x),
    ...
    sf::Rect<int> AABB = sf::Rect<int>(Left, Top, Right, Bottom);
...
bool Collision::PixelPerfectTest(const sf::Sprite& Object1, const sf::Sprite& Object2, sf::Uint8 AlphaLimit) {
    ...
    sf::Rect<int> Object1AABB = GetAABB(Object1);
    sf::Rect<int> Object2AABB = GetAABB(Object2);
    ...
    if (Object1AABB.Intersects(Object2AABB, Intersection)) {
        ...
        sf::Rect<int> O1SubRect = Object1.GetSubRect();
        sf::Rect<int> O2SubRect = Object2.GetSubRect();
			...
			for (int j = Intersection.Top; j < Intersection.Top + Intersection.Height; j++) {
                ...
                if (o1v.x > 0 && o1v.y > 0 && o2v.x > 0 && o2v.y > 0 &&
                    ...
                    //If both sprites have opaque pixels at the same point we've got a hit
							if ((Object1.GetTexture()->CopyToImage().GetPixel(static_cast<int> (o1v.x), static_cast<int> (o1v.y)).a > AlphaLimit) &&
                            (Object2.GetTexture()->CopyToImage().GetPixel(static_cast<int> (o2v.x), static_cast<int> (o2v.y)).a > AlphaLimit)) {
                        return true;
                    }
                }
            }
